...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/ahernandez1801/light-alarm?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=light-alarm&category=integration)
...
1. Download the `custom_components/ha_alarm_clock/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=ha_alarm_clock)
...
Find all entities in **Settings** → **Devices & Services** → **Sunrise Alarm** → click on the device.
...
```yaml
service: ha_alarm_clock.example_action
data:
  # Add your parameters here
```

### `ha_alarm_clock.reload_data`
...
```yaml
service: ha_alarm_clock.reload_data
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Sunrise Alarm → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@ahernandez1801][user_profile]**

---

[commits-shield]: https://img.shields.io/github/commit-activity/y/ahernandez1801/light-alarm.svg?style=for-the-badge
[commits]: https://github.com/ahernandez1801/light-alarm/commits/main
[hacs]: https://github.com/hacs/integration
[hacsbadge]: https://img.shields.io/badge/HACS-Default-orange.svg?style=for-the-badge
[license-shield]: https://img.shields.io/github/license/ahernandez1801/light-alarm.svg?style=for-the-badge
[maintenance-shield]: https://img.shields.io/badge/maintainer-%40ahernandez1801-blue.svg?style=for-the-badge
[releases-shield]: https://img.shields.io/github/release/ahernandez1801/light-alarm.svg?style=for-the-badge
[releases]: https://github.com/ahernandez1801/light-alarm/releases
