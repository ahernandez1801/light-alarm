# Getting Started with Sunrise Alarm

This guide will help you install and set up the Sunrise Alarm custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/ahernandez1801/light-alarm`
6. Set category to "Integration"
7. Click "Add"
8. Find "Sunrise Alarm" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/ahernandez1801/light-alarm/releases)
2. Extract the `ha_alarm_clock` folder from the archive
3. Copy it to `custom_components/ha_alarm_clock/` in your Home Assistant configuration directory
...
4. Select entities from "Sunrise Alarm"
...
- Report issues at [GitHub Issues](https://github.com/ahernandez1801/light-alarm/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/ahernandez1801/light-alarm/discussions)
