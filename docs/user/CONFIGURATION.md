...
This document describes all configuration options and settings available in the Sunrise Alarm custom integration.
...
```yaml
action: ha_alarm_clock.refresh_data
data:
...
- [GitHub Issues](https://github.com/ahernandez1801/light-alarm/issues) - Report problems
